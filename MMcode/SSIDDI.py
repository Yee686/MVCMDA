...
class SSIGCN(nn.Module):
    def __init__(self, args):
        """
        :param args: Arguments object.
        """
        super(SSIGCN, self).__init__()
        self.args = args
        '''
        ...
        '''
        self.gcn_x1_s = GATConv(self.args.fm, self.args.fm)
        self.gcn_x2_s = GATConv(self.args.fm, self.args.fm)

        self.gcn_y1_s = GATConv(self.args.fd, self.args.fd)
        self.gcn_y2_s = GATConv(self.args.fd, self.args.fd)
